...
http://robertpenner.com/easing/easing_demo.html 可以看曲线效果
...
function Tween:Move3D(object, to, time, callback, type)
    local ltDescr = LuaLeanTween.move3d(object, to, time)
    self:SetOptions(ltDescr, type, callback)
    return ltDescr
end
...
function Tween:AlphaCanvas(object, to, time, callback, type)
    local ltDescr = LuaLeanTween.alphaCanvas(object, to, time)
    self:SetOptions(ltDescr, type, callback)
    return ltDescr
end
