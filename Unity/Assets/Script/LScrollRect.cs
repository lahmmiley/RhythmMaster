...
{
    [AddComponentMenu("UI/LScroll Rect", 37)]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    [CustomLuaClass]
    public class LScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        //滚动中改变Content的位置 需要调用这个接口
        public void ContentTranslate(Vector2 offset)
        {
